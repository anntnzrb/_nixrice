...
awful.layout.layouts = {
    ...
    awful.layout.suit.fair, awful.layout.suit.corner.nw,
...
function create_widget(script_path, update_interval)
    local widget = wibox.widget.textbox()

    local function update_widget(widget)
        awful.spawn.easy_async_with_shell(script_path, function(stdout)
...
-- {{{ Key bindings
globalkeys = gears.table.join(awful.key({modkey, "Shift"}, "/",
...
end, {description = "restore minimized", group = "client"}), -- Menubar
