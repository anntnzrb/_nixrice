...
# NPM_LAUNCH
# Launch script that resolves, caches, and executes the agent package
NPM_LAUNCH="${3:-}"
...
require_arg "${NPM_LAUNCH}" "npm launch script"
...
exec "${NPM_LAUNCH}" "${TOOL}" "${PACKAGE}" "${BIN}" latest --version -- "$@"
